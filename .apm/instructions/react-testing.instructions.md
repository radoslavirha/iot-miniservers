---
description: "React + Vitest testing conventions for this monorepo. Use when writing or reviewing tests for UI components, pages, hooks, API clients, and runtime config in ui/**."
applyTo: "ui/**/*.spec.{ts,tsx}"
---
