...
Communication between API and device uses [Xiaomi Mi Home Binary Protocol (miio)](https://github.com/OpenMiHome/mihome-binary-protocol/blob/master/doc/PROTOCOL.md).
