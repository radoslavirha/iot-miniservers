...
API will receive instructions and resend them to devices using defined packet structure (miio protocol). API will automatically perform handshake with device when needed and will cache necessary data.
...
- [miio-api](https://github.com/nt0xa/miio-api)
- [python-miio](https://github.com/rytilahti/python-miio)
- [xiaomi-miio](https://github.com/mvdevries/xiaomi-miio)
