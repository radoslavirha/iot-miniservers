...
- [`ebe9612`](https://github.com/radoslavirha/iot-miniservers/commit/ebe9612aa7fe3263efb91f8488171aab4be7263b) Thanks [@radoslavirha](https://github.com/radoslavirha)! - Read one property per UDP packet in `getProperties`, and drop the `maxChunkSize` parameter.
